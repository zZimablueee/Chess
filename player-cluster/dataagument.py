...
TOPIC_NAME = "Forcing"
#正样本名单
POSITIVE_NAMES = ['Artem Galaktionov', 'Marko Nenezic', 'Vladimir Seliverstov', 'Gabriel Gähwiler', 'Marcos Lianes', 'Miras Assylov', 'Leon Luke Mendonca', 'Alexander Zubov', 'Atanas Dimitrov', 'Vladimir Belous', 'Volodymyr Onyshchuk', 'Mikhail Demidov', 'Bahadir Ozen', 'Cristobal Henriquez', 'Dmitriy Kushko', 'Hikaru Nakamura', 'Vladimir Hamitevici', 'Bardiya Daneshvar', 'champ2005', 'Seyed Poormosavi', 'Yahli Sokolovsky', 'Dmitriy Bocharov', 'Gerson Príncipe', 'Zbigniew Pakleza', 'Seo Jungmin', 'Owen McCoy', 'Gata Kamsky', 'Valery Kazakouski', 'Jose Fernando Cuenca', 'Tomas Laurusas', 'Pranav Anand', 'Eduardo Iturrizaga Bonelli', 'Daniel Tabuenca Mendataurigoitia', 'Julian Antonio Rojas Alarcon', 'Nitin Senthilvel', 'Mohamed Haddouche', 'Oleg Vastrukhin', 'Ajay Karthikeyan', 'German Bazeev', 'Arash Tahbaz', 'Christian Gian Karlo Arca', 'Nikoloz Petriashvili', 'Francesco Sonis', 'Fabiano Caruana', 'Frederick Waldhausen Gordon', 'Igor Janik', 'Carlos Andres Obregón', 'Tamas Banusz', 'ShimanovAlex', 'Slaven Pastar', 'Reinis Paikens', 'Praggnanandhaa Rameshbabu', 'Andrey Gorovets', 'Varuzhan Akobian', 'Jaime Santos Latasa']
#负样本名单
NEGATIVE_NAMES = ['Zachary Tanenbaum', 'Abdulla Gadimbayli', 'Daniil Lintchevski', 'Artiom Samsonkin', 'Gellert Karacsonyi', 'Artem Bardyk', 'Marco Riehle', 'Beksultan Moldagali', 'Aaron Jacobson', 'David Paravyan', 'Ilan Schnaider', 'Nikolozi Kacharava', 'Emin Ohanyan', 'Satria Duta Cahaya', 'Maxim Lugovskoy', 'Sahaj Grover', 'Elham Amar', 'Gevorg Harutjunyan', 'Mykola Bortnyk', 'David Navara', 'Łukasz Licznerski', 'Zaur Mammadov', 'Sravan Renjith', 'PavelShkapenko', 'Steven Zierk', 'Farid Orujov', 'Kaivalya Sandip Nagare', 'Matthias Bluebaum', 'Adar TARHAN', 'Yaroslav Remizov', 'Daniil Plyasunov', 'Svyatoslav Lisenkov', 'Mayank Chakraborty', 'Goltsev Dmitry', 'Sathvik Adiga', 'Christopher Woojin Yoo', 'Benik Agasarov', 'David Gavrilescu', 'Igor L. Vakhlamov', 'Silvius Tiberius', 'Eray Kilic', 'Lucas Do Valle Cardoso', 'Mamedov Edgar', 'Maksim Ivannikov', 'Alexei Shirov', 'Lucas Cumpe', 'Leonardo Tristan', 'Ediz Gürel', 'Yagiz Kaan Erdogmus', 'Seyed Abolfazl Moosavifar', 'Eltaj Safarli', 'Khagan Ahmad', 'Cem Kaan Gokerkan', 'Jakub Kosakowski', 'Luka Paichadze']
...
def data_augmentation(df, target_players, n_samples=20, sample_size=5):
    """数据增强核心逻辑：随机采样并求平均"""
    augmented_rows = []
