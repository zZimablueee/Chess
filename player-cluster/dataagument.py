...
#主题词
TOPIC_NAME = "Positional"
#正样本名单
POSITIVE_NAMES = ['Anton Korobov', 'Dmitriy Bocharov', 'Peter Svidler', 'Valery Skatchkov', 'Vladimir Seliverstov', 'Andrey Gorovets', 'Zviad Izoria', 'Mohamed Haddouche', 'Eduardo Iturrizaga Bonelli', 'Axel Bachmann', 'Sergei Zhigalko', 'Vladimir Belous', 'Volodymyr Vetoshko', 'Nitin Senthilvel', 'Alexey Reshetnikov', 'Gukesh D', 'Nils Grandelius', 'Alvar Alonso Rosell', 'Eric Hansen', 'Zhamsaran Tsydypov', 'David Howell', 'Krzysztof Jakubowski', 'Matías Pérez Gormaz', 'Renato Quintiliano', 'Rinat Jumabayev', 'Vladislav Artemiev', 'Rafael Leitao', 'Alexander Zubov', 'Pavel Eljanov', 'Marko Nenezic', 'Dmitry Gordievsky', 'Zurab Javakhadze', 'Tuan Minh Le', 'Sergey Grigoriants', 'Jeffery Xiong', 'Alexei Kornev', 'Sethuraman S.P', 'Tomas Laurusas', 'Sam Shankland', 'Roman Kezin', 'Gleb Dudin', 'Christian Gian Karlo Arca', 'Volodar Murzin', 'Alexander Grischuk', 'Alon Mindlin', 'Valery Kazakouski', 'Vitaliy Bernadskiy', 'Raja Rithvik R', 'Mikhail Kobalia', 'Ivan Zemlyanskii', 'Vjacheslav Weetik', 'Salem AR Saleh', 'Grigor Grigorov', 'Brandon Jacobson', 'Levon Aronian']
#负样本名单
NEGATIVE_NAMES = ['Kacper Drozdowski', 'Edvin Trost', 'Sathvik Adiga', 'Rustam Rustamov', 'Nathaniel Mullodzhanov', 'Benik Agasarov', 'Marco Riehle', 'Jens E Ingebretsen', 'Mihnea Costachi', 'Patryk Cieslak', 'Mikhail Bryakin', 'Gawain Maroroa Jones', 'Noah Thomforde-Toates', 'Christos Krallis', 'Goltsev Dmitry', 'Gellert Karacsonyi', 'Chesswizard_2007', 'Roman Dehtiarov', 'Andrei Skvortsov', 'Emin Ohanyan', 'Aaron Mendes', 'Jaloliddin Ilkhomi', 'Roman Pyrih', 'Svyatoslav Lisenkov', 'Maksim Ivannikov', 'Valentyn Hulka', 'Harshavardhan GB', 'Aksel Bu Kvaloy', 'Anthony Wirig', 'Kirk Ghazarian', 'IndianGrandmaster13', 'Dinesh Rajan M', 'Akshay Borgaonkar', 'Bojan Maksimović', 'Dimitris Makridis', 'Satria Duta Cahaya', 'Kayden Troff', 'Aleksandr Usov', 'Gunnar Lund', 'Michael Concio Jr.', 'Farid Orujov', 'Elham Amar', 'Georgijs Germanovs', 'Tobias Kölle', 'Maxim Lugovskoy', 'Stanislav Bukreev', 'Seyed Abolfazl Moosavifar', 'Ilan Schnaider', 'Kshatriya Vekhande', 'Artem Bardyk', 'Daniil Lintchevski', 'David Paravyan', 'Eric Rosen', 'Marat Gilfanov', 'David Gavrilescu']
